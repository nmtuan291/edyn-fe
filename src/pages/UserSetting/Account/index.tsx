        ...
        <div className="divide-y divide-surface-100">
            <div className="p-5">
                ...
                <div className="space-y-1">
                    {["Địa chỉ email", "Số điện thoại", "Mật khẩu", "Giới tính"].map((item) => (
                        <button key={item} className="w-full flex items-center justify-between py-3 px-2 rounded-lg hover:bg-surface-50 transition-colors cursor-pointer group">
            ...
            <div className="p-5">
                ...
                <button className="w-full flex items-center justify-between py-3 px-2 rounded-lg hover:bg-red-50 transition-colors cursor-pointer group">
